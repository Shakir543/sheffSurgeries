...
nurseOffice: 'C-451',
nursePhone: '0114 2234433',
surgery: RMSurgery).save()


def App1 = new
Appointment(
appDate: new Date('11/10/2019'),
time: '3:00pm',
appDuration: '30',
...
App1.addToDoctors(BPitt)
PCTL.addToDoctors(BPitt)
SMCentre.addToDoctors(BPitt)
SPeters.addToDoctors(BPitt)
TRivers.addToDoctors(BPitt)

App2.addToDoctors(JFoxx)
IBN.addToDoctors(JFoxx)
RMSurgery.addToDoctors(JFoxx)
RHope.addToDoctors(JFoxx)
MJolie.addToDoctors(JFoxx)
